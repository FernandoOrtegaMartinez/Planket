...
import com.fomdeveloper.planket.data.repository.FlickrRepositoryImpl;
...
public class AppModule {
    ...
    @Provides @Singleton
    public UserHelper provideUserHelper(PlanketBoxPreferences planketBoxPreferences){
        return planketBoxPreferences;
    }
    ...
    @Provides @Singleton
    public RxEventBus provideRxBus(Context context){
    ...
    @Provides @Singleton
    public FlickrRepository provideFlickrRepository(FlickrService flickrService, Context context, PlanketDatabase realm, PlanketBoxPreferences planketBoxPreferences){
        return new FlickrRepositoryImpl(flickrService, context, realm, planketBoxPreferences);
    }
    ...
    private void checkFlickrKeys() {
        if (BuildConfig.FLICKR_API_KEY.equals("YOUR_FLICKR_API_KEY") || BuildConfig.FLICKR_API_KEY.equals("YOUR_CONSUMER_SECRET")){
            throw new RuntimeException("Please add your own Flickr API keys in gradle.properties file. See README.md for more information.");
        }
    }
}
